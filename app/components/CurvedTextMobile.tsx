    ...
    >
      ...
      >
        <textPath href="#textPathMobile" startOffset="0%">
          Favouriteは、志村徹朗によるデザイン活動を行うスタジオです。🌲オンスクリーンメディアのデザイン、グラフィックデザインを中心に、インターネット文化、自転車文化、絵画、ゲーム、アニメ、日々の生活から得たアイデアを活かした制作を行います。🧑🏻‍💻委託制作から企画、文化、コミュニティへの貢献をやっていきます。💪🏻お気軽にご相談ください✏️
        </textPath>
      </text>
    </svg>
  );
